...
const SavingIconStyle = styled.svg`
...
export const SavingIcon = () => {
  return (
    <SavingIconStyle width='13' height='13' viewBox='0 0 13 13' fill='none' xmlns='http://www.w3.org/2000/svg'>
...
const SavedIconStyle = styled.svg`
...
export const SavedIcon = () => {
  return (
    <SavedIconStyle width='14' height='10' viewBox='0 0 14 10' fill='none' xmlns='http://www.w3.org/2000/svg'>
